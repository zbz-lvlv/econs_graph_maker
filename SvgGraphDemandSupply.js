function SvgGraphDemandSupply(){
	...
	this.addDemandLine = function(){
		...
		demandLine.x1 = this.svgGraphItemAxis.yAxisX + 50 + 75 * (this.numberOfDemandLines);
		demandLine.y1 = this.svgGraphItemAxis.yAxisY1 + 50;
		demandLine.y2 = this.svgGraphItemAxis.xAxisY - 50;
	...
	this.addSupplyLine = function(){
		...
		supplyLine.x1 = this.svgGraphItemAxis.yAxisX + 50 + 75 * (this.numberOfSupplyLines);
		supplyLine.y1 = this.svgGraphItemAxis.xAxisY - 50;
		supplyLine.y2 = this.svgGraphItemAxis.yAxisY1 + 50;
